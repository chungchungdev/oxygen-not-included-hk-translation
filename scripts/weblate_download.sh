#!/usr/bin/env bash
# weblate_download.sh — Download translation file from local Weblate instance
...
# ─── Configuration ────────────────────────────────────────────────────────────
WEBLATE_URL="http://localhost:4000/download/oxygen-not-included/strings/zh_Hant_HK/?format=po"
DEST_DIR="$(pwd)/mod"
